...
public class RemoteControlledCarTest {
    ...
    public void testDecreasePower() {
        RemoteControlledCar car = new RemoteControlledCar("black", "simple", "rechargable");
        Assertions.assertEquals(100, car.battery.powerRemaining);
        car.forward(50);
        Assertions.assertNotEquals(100, car.battery.powerRemaining);
        Assertions.assertEquals(95, car.battery.powerRemaining);
        car.backward(-50);
        Assertions.assertEquals(90, car.battery.powerRemaining);
    }
}
